...
const unitString = (string1, string2) => {
  return string1.slice(0, 2).concat(string2.slice(string2.length - 3));
};
console.log(unitString("Paolo", "Francesca"));

/* ESERCIZIO 2 (for)
  Scrivi una funzione che torni un array di 10 elementi; ognuno di essi deve essere un valore random compreso tra 0 e 100 
  (incluso).
*/
const random = () => {
  const numArr = [];
...
console.log(numPari([30, 33, 36, 38, 41, 45, 52, 57, 60, 61]));
...
console.log(numSum([30, 33, 36, 38, 41, 45, 52, 57, 60, 61]));
